        ...
        LazyColumn(
            ...
            items(dirs.size) { index ->
                ...
                Card(
                    ...
                    Box(
                        contentAlignment = Alignment.Center, // Center content alignment
                        modifier = Modifier.fillMaxWidth().padding(16.dp) // Fill width and apply padding
                    ) {
